          ...
          {occasions.map((occ) => (
            <Link key={occ.id} href="/products" className="block h-full">
              <motion.div 
                ...
                className={`${occ.bgColor} rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-6 relative overflow-hidden group hover:shadow-md transition-shadow flex flex-col h-full min-h-[180px] sm:min-h-[200px] md:min-h-[220px] cursor-pointer`}
              >
                <div className="relative z-10 w-full sm:w-2/3">
                  ...
                  <span className="inline-flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-wider hover:text-primary transition-colors">
